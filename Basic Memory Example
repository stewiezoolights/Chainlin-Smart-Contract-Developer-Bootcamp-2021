...
contract MyFirstContract {
    ...
    uint256 number = 0;          //store number in the library
    ...
    function changeNumber(uint256 _num) public {          //input 
        number = _num;        //assign the number as _num
    }
 
 
    function getNumber() public view returns (uint256){      //output
        return number;
    }
}
